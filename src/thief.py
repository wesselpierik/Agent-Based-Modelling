...
class Thief(Person):
    ...
    def step(self):
        ...
        if potential_victims:
            best_victim = max(potential_victims, key=lambda v: -v.get_attentiveness() + v.get_wealth())
        ...
        prob_caught = (0.5*police_parameter + 0.2*(1-business_parameter) + 0.3*(1-best_victim.get_attentiveness()))
