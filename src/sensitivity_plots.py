...
"""
This file processes the output of the sensitivity_analysis.py file and
write the corresponding plot to sensitivity_plots.png. The output file
should be stored in src/sobol_results.txt.

The largest part of this file was generated by AI and manually adjusted
afterwards.
"""
...
# =========================
def extract_matrix_block(text: str, key: str) -> str:
...
def load_matrix(text: str, key: str) -> np.ndarray:
...
def extract_numeric_block(text: str, key: str) -> str:
    """
...
def load_vector(text: str, key: str) -> np.ndarray:
